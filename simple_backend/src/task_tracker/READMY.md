...
# Какие проблемы остались в бекенде на данном этапе проекта (состояние гокни)

 - Одновременные обновления одной и той же задачи могут привести к потере данных.
 - Одновременные запросы на получение и удаление задачи могут вызвать ошибку.
 - Конкурентное создание задач.

 - ## Как решить эту проблему?
  - Использование блокировок или атомарных операций на сервере API.
  - Проверка актуальности данных перед изменением.